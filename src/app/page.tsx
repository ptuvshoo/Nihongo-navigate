    ...
    <div className="flex flex-col min-h-screen bg-slate-50 text-slate-800">
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between h-16 px-4 md:px-8 bg-white/80 backdrop-blur-sm border-b border-slate-200">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-slate-600">
          ...
          <Link href="#" className="hover:text-primary">JLPT Levels</Link>
          <Link href="#" className="hover:text-primary">AI Tools</Link>
          <Link href="/challenge" className="hover:text-primary">Dashboard</Link>
        </nav>
        <Button asChild>
      ...
      <main className="flex-grow pt-16">
        <section className="relative text-center py-20 md:py-32 bg-white overflow-hidden">
            <div className="absolute top-0 left-0 right-0 h-48 bg-gradient-to-b from-purple-100/50 to-white -z-10"></div>
            <div className="container mx-auto px-4 z-10">
                <h1 className="text-4xl md:text-6xl font-extrabold text-slate-900 mb-4 font-headline">Master the JLPT with AI</h1>
                <p className="max-w-2xl mx-auto text-lg text-slate-600 mb-8 font-body">
        ...
        <section className="py-20 md:py-24 bg-slate-50">
          <div className="container mx-auto px-4 text-center">
            <h3 className="text-sm font-semibold uppercase text-primary tracking-wider mb-2 font-headline">Key Features</h3>
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4 font-headline">Learn Smarter, Not Harder</h2>
            <p className="max-w-3xl mx-auto text-slate-600 mb-12 font-body">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <Card className="text-left shadow-lg hover:shadow-xl transition-shadow">
                <CardHeader className="flex flex-row items-center gap-4">
                  ...
                  <CardTitle className="text-xl font-semibold font-headline">Personalized Lessons</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="text-left shadow-lg hover:shadow-xl transition-shadow">
                <CardHeader className="flex flex-row items-center gap-4">
                  ...
                  <CardTitle className="text-xl font-semibold font-headline">Adaptive Practice Tests</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-slate-600 font-body">
